...
if __name__ == "__main__":
    ...
    src_url = '/home/v/i/vishaln/run_results/Unet-S2-CA_Results/run_UNet_src_poly_tgt_poly_s2-train-loss/inference/20230707T19_S2_pred.png'
    geo_url = '/home/v/i/vishaln/datasets/CA_2023_Donnie_creek/S2/post/20230707T19_S2.tif'
    dst_url = '/home/v/i/vishaln/run_results/Unet-S2-CA_Results/run_UNet_src_poly_tgt_poly_s2-train-loss/inference/20230707T19_S2_pred.tif'


    geotiff.convert_png_to_geotiff(src_url, dst_url, geo_url, bandNameList=[], norm=True)
