        ...
        if do_tilling: #  and ('test' == phase)
            ...
            for sat in ["S1"]:
                for folder in os.listdir(workPath / sat):
                    ...
                    geotiff_tiling(phase, src_url, dstFolder, BANDS, BANDS_INDEX, tile_size, True)
